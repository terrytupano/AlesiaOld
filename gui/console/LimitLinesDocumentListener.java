...
public class LimitLinesDocumentListener implements DocumentListener {
	...
	/*
	 * Specify the number of lines to be stored in the Document. Extra lines will be removed from the start of the
	 * Document.
	 */
	...
	/*
	 * Specify the number of lines to be stored in the Document. Extra lines will be removed from the start or end of
	 * the Document, depending on the boolean value specified.
	 */
