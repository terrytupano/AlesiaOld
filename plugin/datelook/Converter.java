...
public class Converter {
   ...
   */
  public static long period2ms(String period, int period_multiplier) {
    // period in ms (at least mean value or more!!)
    if (period.equals(Event.Daily)) {
      return (long) 24 * 60 * 60 * 1000 * period_multiplier;
    }
    else if (period.equals(Event.Weekly)) {
      return (long) 7 * 24 * 60 * 60 * 1000 * period_multiplier;
    }
    else if (period.equals(Event.Monthly)) {
      return (long) 31 * 24 * 60 * 60 * 1000 * period_multiplier;
    }
    else if (period.equals(Event.Yearly)) {
