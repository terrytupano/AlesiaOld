 ...
 * 
 * Principles: - provides a fixed number of rows and columns, but can be resized - each cell can have its own foreground
 * and background colour - The main font determines the grid size
 * 
